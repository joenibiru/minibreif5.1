...
function drawRules(){           
    ...
    ctx.textAlign = "center";
    ctx.font = "30px Chelsea Market";    
    ctx.fillText("Règles", canvas.width/2,40);     
    ...
    ctx.textAlign = "left";
    ctx.fillText("1 ligne néttoyée:   40 points", 30,110);      
    ctx.fillText("2 lignes néttoyée:   100 points", 30,126);      
    ctx.fillText("3 lignes néttoyée:   400 points", 30,141);      
    ctx.fillText("4 lignes néttoyée:   1200 points", 30,156); 
    ctx.font = "15px Chelsea Market";    
    ctx.fillText("worldtris:  4 lignes", 30,175); 
    ctx.font = "20px Caveat";           
    ctx.fillText("Niveaux:", 30,230); 
    ctx.font = "13px Raleway";          
    ctx.fillText("L1: 1 worldtris ou 1200 points", 30, 256);      
    ctx.fillText("L2: 2  worldtris ou 3600 points", 30,271);      
    ctx.fillText("L3: 3 worldtris ou 7200 points", 30,286);      
    ctx.fillText("L4: 4 worldtris ou 12000 points", 30,301); 
    ctx.font = "20px Caveat";           
    ctx.fillText("Comment gagner ?:", 30,350); 
    ctx.font = "13px Raleway";          
    ctx.fillText("Néttoyer L4: Total 10 worltris ou", 30, 376);      
    ctx.fillText("Score 12000 pts", 88, 396);  
    nextCtx.fillStyle="white";    
    nextCtx.font = "18px marvel";    
    nextCtx.fillText("Les pièces suivantes", 20,30); 
    nextCtx.fillText("apparaissent ici", 30,50); 
...
async function drawLevels(level){        
    ...
    ctx.fillText(`Défit: ${level} worldtris`, canvas.width/2,canvas.height/2 + 40); 
    ctx.font = "12px marvel";                   
    ctx.fillText("(Worldtris: 4 Lignes)", canvas.width/2,canvas.height/2 + 70);   
    await sleep(2000);
